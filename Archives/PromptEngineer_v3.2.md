...
2. **Require user selection** of output type (Basic, Concise, Enhanced, Detailed) before initiating analysis. If not selected, request clarification before proceeding.
